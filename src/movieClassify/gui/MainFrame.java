...
import movieClassify.broker.Broker;
...
import movieClassify.domain.Sentences;
...
public class MainFrame extends JFrame {
	...
	public final void initUI() {
		...
		JMenu train = new JMenu("Entrainement du classifieur");

		menubar.add(train);

		JMenu mnIzborKlasifikatora = new JMenu("Choisir un classifieur");
		train.add(mnIzborKlasifikatora);

		JMenuItem mntmLogisticRegre = new JMenuItem("Regression Logistique");
		...
		btAnalyse.setToolTipText("Exécutez l'analyse");
					...
					protected String doInBackground() {
						...
						if (fileChosen != null) {
							...
							JOptionPane.showMessageDialog(null,
									"Entrer des données a analysé !", "Warning", 2);
		...
		btPrint.setToolTipText("Impression des résultat");
		...
		JLabel statusbar = new JLabel("Movie reviews classifier by Mharzi Lhoussine");
		...
		setSize(729, 487);
		setTitle("Movie reviews classification MHARZI");
