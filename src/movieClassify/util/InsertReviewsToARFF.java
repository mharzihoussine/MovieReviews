...
public class InsertReviewsToARFF extends JFrame {
	...
	public InsertReviewsToARFF() {
		...
		btNeg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				File folder = new File("C:/Users/Houssine/Desktop/txt_sentoken/neg");
		...
		btPoz.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				File folder = new File("C:/Users/Houssine/Desktop/txt_sentoken/pos");
				File[] listOfFiles = folder.listFiles();
	...
	public void write(String text, String classReview) {
		...
		try {
			bufferedWriter = new BufferedWriter(new FileWriter("data/movieReviewsTestDataset4.arff", true));
